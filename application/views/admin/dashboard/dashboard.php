        ...
        <div class="col-12 col-xl-12 stretch-card">
            <div class="row flex-grow">
                ...
                <div class="col-md-3 grid-margin stretch-card">
                    <div class="card">
                        <div class="card-body">
                            <span class="opsof" data-placement="top" data-toggle="tooltip" data-original-title="Vous devez passez à PREMIUM pour bénéficier"><?php if(get_user_plan_id()!=3){ ?><i class="link-icon" data-feather="award"></i><?php } ?></span>
                            <div class=" text-center card-title justify-content-between align-items-baseline">
