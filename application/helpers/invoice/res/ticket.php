            ...
            <td colspan="2" style="width: 100%">
                <div class="zone" style="height: 34mm;position: relative;font-size: 5mm;">
                    <div style="text-align: center; font-size: 4mm; ">
                        ...
                        <h4>Facture de paiement</h4><br>
                    </div>

                    <div style="position:relative;left: 10px;">
                        <p>Nom : <b> </b> <span style="position: relative;left:380px;">Sponsor: <b> </b></span></p>
                        <p>Plan : <b> </b></p>
                        <p>Statut : <b> </b></p>
                        <p>Date : <b> <?php echo date('d/m/Y à H:i:s'); ?></b></p>
                        <p>Mode paiement : <b> </b></p>
                        <p>Montant : <b> </b></p>
                        <p>Numero transaction : <b> </b> <span style="position: relative;left:290px;">Numero de code: <b> </b></span></p>
                    </div><br><br>


                        <div style="text-align: center; font-size: 4mm; ">
                            <p style="color: black;">Par ileadglo.com </p>
