...
class Transactions_model extends CI_Model
{
    ...
    public function get($id = '',$where = [])
    {
        ...
        $this->db->select('tbl_transactions.user_id,tbl_transactions.id as id, due,c.name as cluster,by_user_id,u.sponsor as sponsor, u.code as code, num_trans, tbl_transactions.status as status, amount,u.lastname as lastname, u.firstname as firstname, pl.name as plan, p.nom as mde_pement');
    ...
    private function send_invoice($invoice, $tansactions)
    {
        ...
        try {
            ...
            //Recipients
            $mail->setFrom('mail@ileadglobe.com', 'iLead');
